...
isc.Canvas.addMethods({
    ...
    // @attr effect (animateShowEffectId) Effect to apply
    // @attr startFrom (string) For show animations of type <code>"wipe"</code> and
    ...
    // @attr endsAt (string) For hide animations of type <code>"wipe</code> and 
    ...
    fireAnimationShow : function (ratio, ID, earlyFinish) {
        ...
        if (ratio < 1) {
            ...
            if (adjustForScrollbar) handleSize += this.scrollbarSize;
            ...
            this.resizeTo((vertical ? null : handleSize), (vertical ? handleSize : null), true);
            if (info._slideIn) { 
        ...
        // Ratio == 1
            ...
            if (this.overflow == isc.Canvas.AUTO || this.overflow == isc.Canvas.SCROLL) {
                ...
                if (this.hscrollOn && this.hscrollbar) {
                    if (!vertical) delete this.hscrollbar._suppressSetThumb;
    ...
    fireAnimationHide : function (ratio, ID, earlyFinish) {
        ...
        if (ratio < 1) {
            ...
            if (breadthScrollbarSize) handleSize += breadthScrollbarSize;
