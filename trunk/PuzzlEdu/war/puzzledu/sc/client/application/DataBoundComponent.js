...
// +link{dataBoundComponent.invalidateCache,invalidateCache()} to do so.
// <P>
...
// Uses a "fetch" operation on the current +link{DataSource,grid.dataSource} to retrieve data
// that matches the current filter and sort criteria for this component, then exports the 
...
// @see DataBoundComponent.willAcceptDrop();
//
// @visibility external
//<
