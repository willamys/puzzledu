...
isc.RestDataSource.addProperties({
    ...
    // For RestDataSources, +link{RestDataSource.xmlRecordXPath} and
    // +link{RestDataSource.jsonRecordXPath} should be used rather than specifying 
    // <code>recordXPath</code> directly.
    // <P>
