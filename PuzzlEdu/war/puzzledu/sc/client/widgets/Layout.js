...
isc.Layout.addProperties({
    ...
    // Specifies the default alignment for layout members on the breadth axis. Can be overridden
    // on a per-member basis by setting +link{canvas.layoutAlign}.<br>
	...
	// Alignment of all members in this Layout on the length axis.  Defaults to "top" for
...
getLayoutAlign : function (member) {
    ...
    return this.vertical ? isc.Canvas.LEFT : isc.Canvas.TOP;
},
