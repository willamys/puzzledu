...
_1=_1||this.data;_2=_2||this.idField;_3=_3||this.parentIdField;_4=_4||this.rootValue;var _7=[];_7.addList(_1);for(var i=0;i<_7.length;i++){var _9=_7[i];if(_9==null)continue;var _10=_7.find(_2,_9[_3]),_11=[];while(_10!=null){if(_10)_11.add(_10);_10=_7.find(_2,_10[_3])}
if(_11.length>0){for(var _12=(_11.length-1);_12>=0;_12--){this.$640(_11[_12],_2,_3,_6,_4);_7[_7.indexOf(_11[_12])]=null}}
...
var _4=this.getFieldHilites(_1,_2);if(_4!=null)_3=this.applyHiliteHTML(_4,_3);return _3}
...
,isc.A.$30i=function(_1,_2,_3){var _4=(this.destroyed||!this.isDrawn()||!this.isVisible()||isc.EH.targetIsMasked(this.body)||!this.recordIsEnabled(_2,_3));var _5=this.getRecord(_2);if(_1.target=="javascript:void"){_4=true;this.cellClick(_5,_2,_3)}
...
,isc.A.setSelectionType=function(_1,_2){if(!_2&&this.selectionAppearance=="checkbox"){this.$65p=_1;return}
this.selectionType=_1;if(this.body)this.body.selectionType=_1}
,isc.A.setSelectionAppearance=function(_1){if(this.selectionAppearance==_1)return;this.selectionAppearance=_1;if(_1=="checkbox"){this.$65p=this.selectionType;this.setSelectionType(isc.Selection.SIMPLE,true)}else{this.setSelectionType(this.$65p||isc.Selection.MULTIPLE)}
if(this.completeFields!=null){var _2=[];for(var i=0;i<this.completeFields.length;i++){var _4=this.completeFields[i];if(this.isCheckboxField(_4))continue;_2.add(_4)}
this.setFields(_2)}}
...
,isc.A.$31m=function(_1){this.observe(_1,"dataChanged","observer.dataChanged("+(isc.ResultSet&&isc.isA.ResultSet(_1)?"arguments[0],arguments[1],arguments[2],arguments[3])":")"));if(isc.ResultSet&&isc.isA.ResultSet(_1)){this.observe(_1,"dataArrived","observer.dataArrived(arguments[0],arguments[1])")}else if(isc.ResultTree&&isc.isA.ResultTree(_1)){this.observe(_1,"dataArrived","observer.dataArrived(arguments[0])")}
...
,isc.A.dataChanged=function(_1,_2,_3,_4){if(isc.$cv)arguments.$cw=this;var _5=this.groupByField;if(_5!=null&&!this.$52y){if(_1=="add"||_1=="remove"||(_1=="update"&&(_2==null||_3==null)))
...
if(this.body)this.body.finishRowAnimation();if(!this.$31o)this.$31n();var _12=this.getTotalRows()-1;if(this.body){if(this.body.lastOverRow>_12)delete this.body.lastOverRow;if(this.body.$31p>_12)delete this.body.$31p}
if(this.$31q>_12)delete this.$31q;if(this.hilites)this.applyHilites();if(!this.$50w)this.$25a("dataChanged")}
...
this.ignore(_1,"dataChanged");if(this.isObserving(_1,"dataArrived")){this.ignore(_1,"dataArrived")}
...
return _7}
,isc.A.getFieldState=function(_1){var _2=[];if(this.completeFields){var _3=this.header.members;if(this.frozenFields){var _4=this.frozenHeader.members}
for(var i=0;i<this.completeFields.length;i++){var _6=this.completeFields[i],_7=_6[this.fieldIdProperty],_8={name:_7};if(!this.fieldIsVisible(_6))_8.visible=false;if(_1)_8.title=_6.title;if(_3){var _9=_3.find(this.fieldIdProperty,_7);if(!_9&&_4){_9=_4.find(this.fieldIdProperty,_7)}
if(_9&&_9.$pn&&isc.isA.Number(_9.$pn)){_8.width=_9.$pn}}
_2.add(_8)}}
return isc.Comm.serialize(_2)}
...
,isc.A.getCheckboxField=function(){var _1={width:this.$63g+this.$65a()};isc.addProperties(_1,this.checkboxFieldDefaults,this.checkboxFieldProperties);var _2=this.checkboxFieldFalseImage||this.booleanFalseImage;_1.title=this.getValueIconHTML(_2,_1);return _1}
...
return _1[this.recordBaseStyleProperty];var _4=this.getField(_3);if(_4&&_4.baseStyle)return _4.baseStyle;if(_4&&_4.frozen&&this.frozenBaseStyle)return this.frozenBaseStyle;if(this.isPrinting&&(this.printBaseStyle!=null))return this.printBaseStyle;var _5=this.baseStyle;if(_5==null){if(this.cellHeight!=isc.ListGrid.getPrototype().cellHeight||!this.shouldFixRowHeight(_1,_2))
{_5=this.tallBaseStyle}else{_5=this.normalBaseStyle}}
return _5}
);isc.evalBoundary;isc.B.push(isc.A.getCellCSSText=function(_1,_2,_3){if(_1){var _4=_1[this.recordCSSTextProperty];if(_4!=null)return _4}
...
_1=this.$300(_2,_3)}
var _5=this.fields[_3],_6=null;if(_5==null)return"";if(this.isCheckboxField(_5)&&!_1.$52e){var _7=this.selection.isSelected(_1)?true:false;var _8=_7?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage)
...
return _2}
,isc.A.getEditorValueMap=function(_1,_2){if(_1.editorValueMap!=null){return _1.editorValueMap}
...
var _6=isc.isA.String(_2)?_2:this.getEditorName(_1,_2);if(isc.isA.String(_2))_2=this.getFieldNum(_2);var _7=this.$33l(_1,_2,_6,_3,_5);if(!_7)return;var _8=this.getField(_6);if(_8&&this.$425(_8)){var _9;var _10=this.getEditForm();if(_10&&this.getEditRow()==_1&&this.fieldValuesAreEqual(_8,_10.getValue(_6),_3))
...
if(this.data)this.data.remove(_1);if(_2){this.fireCallback(_2,"dsResponse,data,dsRequest",[null,_1,_3])}}
...
,isc.A.drop=function(){if(this.willAcceptDrop()==false)return false;var _1=this.ns.EH.dragTarget;var _2=this.getDropIndex(null,null);var _3=this.getDataSource(),_4=_1.getDataSource();if(_3&&_3==_4){var _5=_1.getDragData()}else{_5=(this.canReorderRecords&&_1==this?this.selection.getSelection():_1.transferDragData?_1.transferDragData():null)}
var _6=this.data.get(_2);return this.recordDrop(_5,_6,_2,_1)}
...
);isc.evalBoundary;isc.B.push(isc.A.getData=function(){return this.data}
...
if(_1==null)_1=this.getEventRow();if(_2==null)_2=this.getReorderPosition(_1);if(this.canReorderRecords){if(_1==-2){_1=this.data.getLength()-1;_2=this.getReorderPosition(_1)}}
return _1+(_2==isc.ListGrid.AFTER?1:-1)}
...
,isc.A.$63m=function(_1){var _2=this.isRTL()?this.fields.length:0,_3=this.fields[_2];if(!this.isCheckboxField(_3))return;var _4=_1?(this.checkboxFieldTrueImage||this.booleanTrueImage):(this.checkboxFieldFalseImage||this.booleanFalseImage),_5=this.getValueIconHTML(_4,_3);this.setFieldTitle(_2,_5);_3.$63h=_1}
,isc.A.headerClick=function(_1,_2){var _3=_2.getMember(_1).masterIndex,_4=this.fields[_3];if(this.isCheckboxField(_4)){if(_4.$63h){this.deselectAllRecords();this.$63m(false)}else{this.selectAllRecords();if(!isc.ResultSet||!isc.isA.ResultSet(this.data)||this.data.allMatchingRecordsCached()){this.$63m(true)}}
return false}
...
);isc.evalBoundary;isc.B.push(isc.A.sorterClick=function(){if(!this.canSort)return false;var _1=this.$60z();this.sort(_1,(_1!=null?!Array.shouldSortAscending(this.getField(_1).sortDirection):null))}
...
,isc.A.regroup=function(_1){if(!this.isGrouped||(this.canGroupBy==false)||!this.groupByField||!this.groupByField.length||this.inhibitRegroup||!(this.originalData||this.data))return;var _2;if(this.data.isGroupedOutput&&this.originalData)_2=this.originalData;else this.originalData=_2=this.data;var _3=_2.getLength();if(isc.ResultSet&&isc.isA.ResultSet(_2)&&(!_2.lengthIsKnown()||!_2.rangeIsLoaded(0,_3-1)))
...
this.groupTree=this.createAutoChild("groupTree",{dataSource:this.dataSource,defaultLoadState:isc.Tree.LOADED,loadDataOnDemand:false,idField:this.groupIdField,parentIdField:this.groupParentIdField,titleProperty:"groupValue",childrenProperty:"groupMembers",parentProperty:"_groupTree_"+this.ID,showRoot:false,isGroupedOutput:true},(this.dataSource?isc.ResultTree:isc.Tree));this.logInfo("Adding "+_2.getLength()+" records to groups","grouping");for(var i=0;i<_2.getLength();i++){this.$52u(_2.get(i),false)}
var _5=this.groupTree.getRoot(),_6=0,_7=0,_8=this.groupTree;while(_5!=null&&_7<this.groupByField.length){var _9=_8.getChildren(_5);for(var i=0;i<_9.length;i++){var _10=(this.completeFields||this.fields).find(this.fieldIdProperty,this.groupByField[_7]);var _11=_10.getGroupTitle?"false":!_10.getGroupValue?(_10.$62&&_10.$62.getGroupTitle)?"true":null:null;var _12=_9[i];if(_11=="false"){_12.singleCellValue=_10.getGroupTitle(_12.groupValue,_12,_10,_10.name,this)}
else if(_11=="true"){_12.singleCellValue=_10.$62.getGroupTitle(_12.groupValue,_12,_10,_10.name,this)}}
...
);isc.B._maxIndex=isc.C+66;isc.TreeGrid.registerStringMethods({folderOpened:"node",folderClosed:"node",folderClick:"viewer,folder,recordNum",leafClick:"viewer,leaf,recordNum",nodeClick:"viewer,node,recordNum",folderContextClick:"viewer,folder,recordNum",leafContextClick:"viewer,leaf,recordNum",nodeContextClick:"viewer,node,recordNum",dataArrived:"parentNode"});isc.ClassFactory.defineClass("ButtonStrip","GridRenderer");isc.A=isc.ButtonStrip.getPrototype();isc.A.buttons=[];isc.A.buttonDefaults={};isc.A.buttonSpacing=3;isc.A.buttonPadding=2;isc.A.defaultButtonHeight=20;isc.A.defaultButtonWidth=100;isc.A.vertical=false;isc.A.overflow=isc.Canvas.VISIBLE;isc.A.showRollOver=true;isc.A.useCellRollOvers=true;isc.A.canDrag=false;isc.A.canDragSelect=false;isc.A.canSelectCells=false;isc.A.fastCellUpdates=true;isc.A.titleAlign="center";isc.A.fillSpace=false;isc.A.backgroundColor=null;isc.A.baseStyle="button";isc.A=isc.ButtonStrip.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.initWidget=function(){this.Super(this.$oc);if(this.buttonPadding!=null)this.cellPadding=this.buttonPadding;if(this.buttonSpacing!=null)this.cellSpacing=this.buttonSpacing;var _1=[];for(var i=0;i<this.buttons.length;i++){this.buttons[i]=isc.addProperties({},this.buttonDefaults,this.buttons[i]);if(this.vertical)_1[i]=this.buttons[i].height}
...
_2=isc.DataSource.filterCriteriaForFormValues(_2);var _6={};if(_1)_6.showPrompt=false;var _7=this.sourceWidget.data,_8=this.sourceWidget.autoFetchAsFilter;if(isc.isA.ResultSet(_7)&&_7.willFetchData(_2)){this.fireOnPause("performFilter",{target:this.sourceWidget,methodName:(_8?"filterData":"fetchData"),args:[_2,null,_6]},this.fetchDelay)}else{if(_8){this.sourceWidget.filterData(_2,null,_6)}else{this.sourceWidget.fetchData(_2,null,_6)}}}
...
return null}
,isc.A.drop=function(){var _1=this.$610||0;var _2=this.ns.EH.dragTarget;if(!isc.isAn.Array(_2))_2=[_2];var _3=_2[0].parentElement;if(_1==null)_1=this.data.getLength()
else _1=Math.min(_1,this.data.getLength());var _4=this.tiles.findIndex("ID",_2[0].ID);if(_4!=-1&&_4<_1)_1+=_2.length;var _5=this.data.get(_1);this.transferRecords(_2,_5,_1,_3);isc.Timer.setTimeout(this.ID+".$583()",200)}
...
);isc.B._maxIndex=isc.C+29;isc.ColumnTree.registerStringMethods({nodeSelected:"column, node"})
...
return false}
);isc.B._maxIndex=isc.C+37;isc.ClassFactory.defineClass("FieldEditor","Window");isc.A=isc.FieldEditor.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.isModal=true;isc.A.showMinimizeButton=false;isc.A.autoCenter=true;isc.A.autoSize=true;isc.A.defaultWidth=375;isc.A.visibleFieldsConstructor="ListGrid";isc.A.hiddenFieldsConstructor="ListGrid";isc.A.showFooter=false;isc.A.title="Customize Fields";isc.A.showInstructionsPane=true;isc.A.bodyProperties={layoutMargin:5};isc.A.instructionsPaneDefaults={_constructor:isc.HTMLFlow,padding:5,height:1};isc.A.instructions="Drag fields between grids to control which fields are visible "+"and the order in which fields are displayed";isc.B.push(isc.A.initWidget=function(){this.invokeSuper(isc.FieldEditor,"initWidget");if(!this.fields){isc.logWarn('FieldEditor can not be created because no fields were provided');return}
this.addItem(this.addAutoChild("instructionsPane",{contents:this.instructions}));var _1={showHeader:false,height:200,width:150,leaveScrollbarGap:false,fields:[{name:"title",formatCellValue:"value || record.name"}],canDragRecordsOut:true,canAcceptDroppedRecords:true,canReorderRecords:true,dragDataAction:"move"};var _2=this.visibleFieldsGrid=this.createAutoChild("visibleFields",_1);var _3=this.fields;var _4=_3.findAll("visible",null);var _5=_3.findAll("visible",false);_2.setData(_4);_1.canReorderRecords=false;var _6=this.hiddenFieldsGrid=this.createAutoChild("hiddenFields",_1);_6.setData(_5);var _7=isc.HStack.create({membersMargin:10,height:1,overflow:"visible",members:[isc.VStack.create({layoutMargin:5,membersMargin:5,members:[isc.Label.create({autoFit:true,contents:"<nobr><b>Visible Fields</b></nobr>"}),_2]}),isc.VStack.create({width:32,height:74,layoutAlign:"center",membersMargin:10,members:[isc.Img.create({src:"[SKINIMG]actions/back.png",width:16,height:16,visFieldsGrid:_2,hidFieldsGrid:_6,layoutAlign:"center",click:"this.visFieldsGrid.transferSelectedData(this.hidFieldsGrid)"}),isc.Img.create({src:"[SKINIMG]actions/forward.png",width:16,height:16,layoutAlign:"center",visFieldsGrid:_2,hidFieldsGrid:_6,click:"this.hidFieldsGrid.transferSelectedData(this.visFieldsGrid)"})]}),isc.VStack.create({layoutMargin:5,membersMargin:5,members:[isc.Label.create({autoFit:true,contents:"<nobr><b>Hidden Fields</b></nobr>"}),_6]})]});this.addItem(_7);var _8=this.createAutoChild("okButton",{autoDraw:false,title:"Done",fieldEditor:this,click:function(){this.creator.okClick()},layoutAlign:"center"},isc.IButton);this.addItem(_8)}
