...
//   });
// </pre>
// If you have existing test data in XML (see the +link{Admin Console} for expected format),
...
isc.DataSource.addProperties({
    ...
    // Analagous to +link{dataSource.dropExtraFields}, for data sent to the server.  Setting this
...
// @value "date"      A date. Represented on the client as a JavaScript <code>Date</code> object. 
//                    Note that, although JS <code>Date</code> objects also contain time 
//                    information, this is normalized out for a SmartClient "date" (ie, the time
//                    elements are all set to 0).  See +link{class:Date} for
...
// a valid server-side class that extends <code>com.isomorphic.datasource.DataSource</code>.
...
isc.DataSource.addMethods({
    ...
    // @return (DSDataProtocol) DataProtocol to be used for this request operation.
    // @visibility external
    //<
    ...
    exportData : function (criteria, requestProperties) {
        ...
        parameters.exportFields = requestProperties.exportFields  || this.getVisibleDSFields();
...
// @value "csv"    Export data in comma-seperated format
//
// @visibility external
//<
...
// (+link{customSQL} and +link{customHQL}).  See the +explorerExample{javaDataIntegration,Java
// Integration samples}.
// <P>
...
// +link{OperationBinding.customHQL,HQL}, or you replace individual parts of the query 
...
// can refer to any function supported by the underlying database.  The server will 
...
// <p>
// You may find the SmartClient-provided <b>$valjues</b> variable of particular use with
// this property.
// <p>
// See the documentation for +link{customSQL} for usage examples
//
...
// &nbsp;&nbsp;&lt;customSQL&gt;<br>
// &nbsp;&nbsp;&nbsp;&nbsp;UPDATE $defaultTableClause SET $defaultValuesClause WHERE bar <= $criteria.someValue<br>
// &nbsp;&nbsp;&lt;/customSQL&gt;<br>
// &lt;/operationBinding&gt;<br>
// </code>
//
...
//<
    ...
    supportsTextMatchStyle : function (style) {
        ...
        return (style == null || style == this._$substring || style == this._$exact ||
                ...
                (style == this._$startsWith && this.clientOnly));
    },
