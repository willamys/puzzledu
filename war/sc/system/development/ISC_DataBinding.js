...
var _12=this.getDataURL(_1);_12=_1.actionURL||_1.dataURL||_12;var _13,_14=_2.defaultParams||this.defaultParams,_15=_1.params;if(_14||_15){_13=isc.addProperties({},_14,_15)}
var _16=_6=="getParams"||_6=="postParams";if(_16){_13=isc.addProperties(_13||{},_1.data)}
if(_16){if(_13)_13=this.serializeFields(_13,_1);return{actionURL:_12,httpMethod:_1.httpMethod||(_6=="getParams"?"GET":"POST"),params:_13}}
var _17={actionURL:_12,httpMethod:_1.httpMethod||"POST"};if(_13)_17.params=_13;if(_6=="postMessage"){_17.data=(_1.data||"").toString()}
if(_6=="postXML"||_6=="soap"){var _18=_17.data=this.getXMLRequestBody(_1);_17.contentType=_1.contentType||"text/xml";this.logDebug("XML post requestBody is: "+_18,"xmlBinding")}
if(_6=="soap"){var _19=this.$du(_2.soapAction,_4.soapAction);if(_19!=null){if(isc.isAn.emptyString(_19))_19='""';_17.httpHeaders=isc.addProperties({SOAPAction:_19},_1.httpHeaders)}}
this.logDebug("serviceInputs are: "+this.echo(_17),"xmlBinding");return _17}
...
,isc.A.exportData=function(_1,_2){if(!_2)_2={};if(_2.exportAs&&_2.exportAs.toLowerCase()=="json"){isc.logWarn("Export to JSON is not allowed from a client call - set "+"operationBinding.exportAs on your DataSource instead.");return}
if(_2.textMatchStyle==null)_2.textMatchStyle="substring";var _3={};_3.exportResults=true;_3.exportAs=_2.exportAs||"csv";_3.exportFilename=_2.exportFilename||"Results."+_3.exportAs;_2.exportFilename=_3.exportFilename;_3.exportDisplay=_2.exportDisplay||"download";_3.lineBreakStyle=_2.lineBreakStyle||"default";_3.exportFields=_2.exportFields||this.getVisibleDSFields();_2.downloadResult=true;_2.downloadToNewWindow=_2.exportDisplay=="window"?true:false;if(_2.downloadToNewWindow){if(_3.exportFilename.endsWith(".xml")&&_3.exportAs!="xml"){_3.exportFilename=_3.exportFilename+".txt"}
...
,isc.A.downloadFile=function(_1,_2,_3){this.$38i("downloadFile",_1,_2,_3)}
,isc.A.viewFile=function(_1,_2,_3){this.$38i("viewFile",_1,_2,_3)}
,isc.A.streamFile=function(_1,_2,_3){_3=isc.addProperties({$38j:true,downloadResult:true},_3);return this.$38i("viewFile",_1,_2,_3)}
,isc.A.$38i=function(_1,_2,_3,_4){if(!_4)_4={};if(!_3){var _5=this.getFields();for(var _6 in _5){if(_5[_6].type=="binary"){_3=_6;break}}}
if(!_3){this.logError("fieldName not provided an no binary fields present in the"+" passed recordKeys")}
_4.downloadResult=true;_4.downloadToNewWindow=_1=="viewFile"?true:false;_4.showPrompt=false;var _7=this.filterPrimaryKeyFields(isc.clone(_2));_7.download_fieldname=_3;_4.download_filename=_2[_3+"_filename"];_7.download_filename=_4.download_filename;return this.performDSOperation(_1,_7,null,_4)}
...
return _3}
);isc.evalBoundary;isc.B.push(isc.A.getLocalFields=function(_1){if(this.$38k)return this.fields;if(_1)return this.fields;this.$38l();this.$63p();this.$38k=true;return this.fields}
...
,isc.A.$63p=function(){if(!this.autoDeriveTitles)return;for(var _1 in this.fields){var _2=this.fields[_1];if(_2.title&&_2.title!="")continue;_2.title=this.getAutoTitle(_1)}}
...
,isc.A.supportsTextMatchStyle=function(_1){if(!this.clientOnly&&(this.dataFormat!=this.$50j))return true;return(_1==null||_1==this.$19q||_1==this.$50i||(_1==this.$45y&&this.clientOnly))}
...
return 1}
return _7}
);isc.B._maxIndex=isc.C+135;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$628=0;isc.B.push(isc.A.addSearchOperator=function(_1){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
,isc.A.getAutoTitle=function(_1,_2){_2=_2||/[_\$]/g;if(!isc.isA.String(_1))_1=_1.toString();var _3;_4=_1.replace(_2," ");var _4=_4.replace(/^\s+|\s+$/g,"");if(_4==_4.toUpperCase()||_4==_4.toLowerCase()){_4=_4.toLowerCase();var _5=true;_3="";for(var i=0;i<_4.length;i++){var _7=_4.substr(i,1);if(_5){_7=_7.toUpperCase();_5=false}
...
return _3}
);isc.B._maxIndex=isc.C+4;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.addSearchOperator=function(_1,_2){if(!_1||!_1.ID){isc.logWarn("Attempted to add null search operator, or operator with no ID");return}
...
,isc.A.clearTransaction=function(_1){_1=this.getTransaction(_1);this.clearTransactionTimeout(_1);isc.Comm.closeOperationPromptWindow(_1);if(!this.$453&&isc.Page.isLoaded()){var _2=isc.LogViewer.getGlobalLogCookie();this.setTrackRPC(_2?_2.trackRPC:false)}
...
,isc.A.$39b=function(_1){_1=this.getTransaction(_1);if(_1.$387){isc.Comm.closeOperationPromptWindow(_1);this.clearTransaction(_1);return}
...
,isc.A.resubmitTransaction=function(_1){_1=this.getTransaction(_1)||this.getLastSubmittedTransaction();_1.status=null;var _2=this.currentTransaction;this.currentTransaction=_1;if(_1!=null){this.logInfo("Resubmitting transaction number: "+_1.transactionNum);isc.Comm.closeOperationPromptWindow(_1);delete _1.suspended;delete _1.clearedPrompt;this.sendQueue()}else{this.logWarn("No transaction to resubmit: transaction number "+_1+" does not exist")}
...
_4.receiveTime=isc.timeStamp();_4.changed();isc.RPCManager.$410.remove(_1);this.logInfo("transaction "+_1+" arrived after "+(_4.receiveTime-_4.sendTime)+"ms");if(_3)_4.$ch=_3;if(_2==null){this.logFatal("No results for transaction "+_1);isc.Comm.closeOperationPromptWindow(_4);return false}
...
,isc.A.$455=function(_1){var _2=_1.indexOf(this.$381);if(_2!=-1){return _1.substring(_2+this.$381.length,_1.lastIndexOf(this.$382))}
return _1}
...
var _3;if(_2.transport=="scriptInclude"){}else if(isc.isAn.Array(_2.results)){_3=true}else
if(_2.allClientOnly){_2.results={status:0}}else{var _4=_2.results?_2.results.indexOf(this.$381):-1;_3=_4!=-1;if(_3){var _5=_2.results;_5=this.$455(_5);try{_2.results=isc.eval(_5)}catch(e){this.logWarn("Error evaling structured RPC response: "+e+" response text: "+_5)}}}
var _6=_2.results;if(_3&&!isc.isAn.Array(_6))_6=[_6];var _7=_2.operations,_8=[];for(var i=0,j=0;i<_7.length;i++){var _11=_7[i];var _12=isc.addProperties(this.createRPCResponse(_2,_11),{isStructured:_3,callbackArgs:_2.transport=="scriptInclude"?_6:null,results:_3?_6[j++]:_6});if(_12.status==null)_12.status=0;if(_12.isStructured){if(_12.results.errors){var _13=_12.results.errors;if(isc.isAn.Array(_13)&&_13.length==1){_13=_13[0]}}
if(_12.results){isc.addProperties(_12,_12.results)}}
_8[i]=_12;_2.responses[i]=_12;_2.changed()}
var _14=0;while(_14<_7.length&&!_2.suspended){var _11=_7[_14],_12=_8[_14];this.performOperationReply(_11,_12);_14++}
if(_2.showPrompt)this.doClearPrompt(_2);if(!_2.suspended){this.clearTransaction(_1)}
if(_2.offline)this.playbackNextOfflineTransaction();if(_2.$40c){var _15=_11.application?_11.application:this.getDefaultApplication();if(isc.isA.String(_15))_15=window[_15];_15.fireCallback(_2.$40c,"responses",[_2.responses])}}
,isc.A.performOperationReply=function(_1,_2){var _3=_2.results,_4=_1.operation;if(this.logIsInfoEnabled()){if(_2.isStructured){this.logInfo("rpcResponse("+_4.ID+")["+_4.type+"]: result: "+(_3==null?"null":(isc.isAn.Array(_3.data)?_3.data.length+" records":"object")+"[status="+(_3.status!=null?_3.status:"unknown")+"]"))}else{this.logInfo("rpcResponse(unstructured) results -->"+isc.Log.echoAll(_3)+"<--")}}
...
,isc.A.evalResult=function(_1,_2,_3){var _4=_1.evalVars;this.logDebug("evaling result"+(_4?" with evalVars: "+isc.Log.echo(_4):""));var _5=isc.Canvas.getInstanceProperty("autoDraw");if(_1.suppressAutoDraw)isc.Canvas.setInstanceProperty("autoDraw",false);if(_2.isStructured)_3=_3.data;var _6=isc.Class.evalWithVars(_3,_4);if(_1.suppressAutoDraw)isc.Canvas.setInstanceProperty("autoDraw",_5);return _6}
,isc.A.fireReplyCallbacks=function(_1,_2){var _3=_1.operation,_4=_2.results,_5=_1.evalResult&&_1.transport!="scriptInclude"?this.evalResult(_1,_2,_4):null;var _6;if(_2.isStructured)_6=_2.data
else
...
);isc.B._maxIndex=isc.C+66;isc.RPCManager.rpc_logMessage=isc.RPCManager.logMessage;isc.RPCManager.logMessage=function(_1,_2,_3,_4){if(this.logIsEnabledFor(_1,_3)){if(isc.isA.String(_2)&&_2.length>this.maxLogMessageLength&&!this.logIsEnabledFor(_1,"RPCManagerResponse"))
...
isc.A=isc.RPCManager;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.performOperation=function(_1,_2,_3,_4){isc.rpc.app().performOperation(_1,_2,_3,_4)}
);isc.B._maxIndex=isc.C+1;isc.A=isc.DataSource;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$37s={};isc.B.push(isc.A.loadSchema=function(_1,_2,_3){var _4=isc.DataSource.$37s;if(_4[_1]){_4[_1].add(_2);return null}
_4[_1]=[];_4[_1].add(_2);var _5=_1+"_loadSchema";_3=_3||{};if(!_3.prompt)_3.prompt="loading datasource '"+_1+"'";this.logInfo("performing operation: "+_5);isc.rpc.performOperation(_5,{},"isc.DS.$37y(rpcResponse,data)",_3)}
,isc.A.$37y=function(_1,_2){var _3=_2[0].dsName;if(_1.status!=0){isc.DataSource.logError("dynamic datasource fetch failed for datasource '"+_3+"'.");return}
var _4=_2[0].dsData;isc.eval(_4);var _5=isc.DS.get(_3);var _6=isc.DataSource.$37s;for(var i=0;i<_6[_3].length;i++){isc.DataSource.logInfo("calling registered callback: "+(_6[_3])[i]);this.fireCallback(_6[_3][i],"ds",[_5],_5)}
delete _6[_3]}
);isc.B._maxIndex=isc.C+2;isc.A=isc.DataSource.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.performSCServerOperation=function(_1){var _2=this.transformRequest(_1);_2=this.serializeFields(_2,_1);_1.oldValues=this.serializeFields(_1.oldValues,_1);var _3=isc.addProperties({},_1);var _4=this.getDataURL(_1);if(_4)_3.actionURL=_4;var _5=_1.operationType;var _6=_3.data=this.prepareDataSourceData(_5,_2,_1);var _7=_1.textMatchStyle;if(_5=="filter"){_5="fetch";if(_7==null)_7="substring"}
var _8=_6.operationConfig={dataSource:this.ID,operationType:_5};if(_7)_8.textMatchStyle=_7;isc.addProperties(_6,_1.appInputs,_1.parameters);if(_1.startRow!=null){_6.startRow=_1.startRow}
...
var _9=_3.application||isc.RPCManager.getDefaultApplication();if(isc.isAn.Object(_9))_9=_9.ID;var _10=_3.operation||_3.operationId||this.ID+"_"+_5;if(isc.isAn.Object(_10))_10=_10.ID;isc.addProperties(_6,{appID:_9,operation:_10,oldValues:_1.oldValues});_3.$374=_1;this.logInfo("performDSOperation("+_5+") "+(isc.isAn.Array(_2)?_2.length:1)+" records"+(isc.rpc.queuing?", queuing":""));_3.callback={target:this,methodName:"$50h"};if(isc.DataSource.addMetaDataToQueryString){if(!_3.queryParams)_3.queryParams={};isc.addProperties(_3.queryParams,{ds_name:_1.dataSource,ds_op:_1.operationType});if(_1.startRow!=null){isc.addProperties(_3.queryParams,{ds_startRow:_1.startRow,ds_endRow:_1.endRow})}
if(_1.sortBy)_3.queryParams.ds_sortBy=_1.sortBy}
return isc.RPCManager.sendRequest(_3)}
,isc.A.$50h=function(_1,_2,_3){var _4=_3.$374;this.$38b(_2,_1,_4,_1,_3)}
,isc.A.prepareDataSourceData=function(_1,_2,_3){var _4=isc.DS.$372(_1);switch(_4){case"fetch":case"remove":case"downloadFile":case"viewFile":_2={criteria:_2};break;case"add":case"replace":case"validate":_2={values:_2};break;case"update":var _5=_2;var _6=(_3&&_3.values)?_3.values:_2;var _7=this.filterPrimaryKeyFields(_5);if(!_7)return null;if(!_6)return null;_2={criteria:_7,values:_6};break;default:_2={values:_2};break}
return _2}
);isc.B._maxIndex=isc.C+3;isc.A=isc.InstantDataApp.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.getOperationConfig=function(_1){if(isc.isAn.Object(_1))return _1;if(this.operations)return this.operations[_1]}
,isc.A.performOperation=function(_1,_2,_3,_4){if(!_4)_4={};else if(!isc.isAn.Object(_4)){this.logWarn("performOperation(): passed an invalid context: '"+_4+"', ignoring");return false}
...
,isc.A.generateJSCallback=function(_1){var _2=_1.transactionNum,_3=_1.callback,_4=isc.Comm.alwaysSendInNewWindow?"window.opener.parent.isc.Comm.hiddenFrameReply("+_2+",results,window)":"parent.isc.Comm.hiddenFrameReply("+_2+",results)";_1.requestData.jscallback=_4;this.$50c[_2]=_3}
,isc.A.getTargetableFrame=function(_1){var _2;_2=isc.HiddenFrame.newInstance();return _2}
,isc.A.hiddenFrameReply=function(_1,_2,_3){var _4=this.$50c[_1];delete this.$50c[_1];if(_4)this.fireCallback(_4,"transactionNum,results,wd",[_1,_2,_3])}
,isc.A.closeOperationPromptWindow=function(_1){if(!_1||_1.transport!="hiddenFrame")return;var _2=_1.$ch;if(_2==null)return;_1.$ch=null;if(isc.isA.HiddenFrame(_2)){_2.destroy();isc.HiddenFrame.$h7()}else{if(isc.isA.Function(_2.close))_2.close()}}
);isc.B._maxIndex=isc.C+5;isc.A=isc.Canvas;isc.A.resizeThumbConstructor=isc.Canvas;isc.A.resizeThumbDefaults={width:8,height:8,overflow:"hidden",styleName:"resizeThumb",canDrag:true,canDragResize:true,getEventEdge:function(){return this.edge},autoDraw:false};isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.B.push(isc.A.$40f=function(){var _1=isc.Canvas.getInstanceProperty("edgeCursorMap"),_2={},_3=isc.ClassFactory.getClass(this.resizeThumbConstructor);for(var _4 in _1){_2[_4]=_3.create({ID:"isc_resizeThumb_"+_4,edge:_4},this.resizeThumbDefaults,this.resizeThumbProperties)}
isc.Canvas.$40g=_2}
...
continue;if(_19){var _21;if(_21=_15.match(/src=('|")?([^'"> ]*)/i)){_11.add(_21[2]);_10.add(null)}else{if(!isc.isA.String(_18)||isc.isAn.emptyString(_18))continue;_10.add(_18);_11.add(null)}
_12.add(null)}else{this.logWarn("html to be evaluated contains non-JS script tags - these will be"+" ignored.  Tag: "+_15)}}
if(_12.length==0)
_12=[_13];else
_12.push(_13);if(_11.length>0&&!_4){if(isc.RPCManager){var _22=false;for(var i=0;i<_11.length;i++){if(_11[i]==null){continue}
...
,isc.A.addNewClause=function(_1){var _2=isc.clone(this.filterRow);var _3=this.getDataSource().getFieldNames(true);var _4={};for(var i=0;i<_3.length;i++){var _6=_3[i];if(this.showFieldTitles){var _7=this.getDataSource().getField(_6).title;_7=_7?_7:_6;_4[_6]=_7}else{_4[_6]=_6}}
...
var _8=this.getDataSource().getFieldOperatorMap(_3[0],false,"criteria",true);_2[1].valueMap=_8;if(_1&&_1.operator){_2[1].defaultValue=_1.operator}else{_2[1].defaultValue=isc.firstKey(_8)}
var _9=this.getDataSource().getSearchOperator(_2[1].defaultValue),_10=this.getDataSource().getField(_2[0].defaultValue);if(!_9){isc.logWarn("Criterion specified unknown operator "+_1.operator+". Using the first valid operator ("+isc.firstKey(_8)+") instead");_2[1].defaultValue=isc.firstKey(_8);_9=this.getDataSource().getSearchOperator(_2[1].defaultValue)}
var _11=this.buildValueItemList(_10,_9);if(_1){if(_1.value!=null&&_11.containsProperty("name","value")){_11.find("name","value").defaultValue=_1.value}
...
this.gridFields=_2.fields;_2.show()}
...
isc.rpc.startQueue();var _4=isc.DataSource.getDataSource(this.grid.dataSource);for(var i=0;i<_1.length;i++){_4.addData(this.grid.getEditedRecord(i),function(){isc.say("Records added",function(){_2.cleanup()})},isc.addProperties({actionURL:this.dataURL},this.requestProperties))}
isc.rpc.sendQueue()}
